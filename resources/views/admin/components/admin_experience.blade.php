...
<div class="resume-section-content">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="flex-grow-1">
            <h3 class="mb-0">Internship - Programmer</h3>
            <div class="subheading mb-3">Kominfo West Sumatra</div>
            <p>work closely with other programmers to design and create systems according to client requests</p>
        </div>
        {{-- <div class="flex-shrink-0"><span class="text-primary">Agustus - September 2017</span></div> --}}
    </div>
</div>
</section>
<hr class="m-0" />
